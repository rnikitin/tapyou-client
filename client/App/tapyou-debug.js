...
define('durandal/viewEngine',['./system', 'jquery', 'ko'], function (system, $, ko) {
    var parseMarkupCore;
...
define('durandal/viewModelBinder',['./system', 'ko'], function (system, ko) {
    var viewModelBinder;
...
define('durandal/viewModel',['./system', 'ko'], function (system, ko) {
    var viewModel;
...
define('durandal/composition',['./viewLocator', './viewModelBinder', './viewEngine', './system', './viewModel', 'ko'],
    function (viewLocator, viewModelBinder, viewEngine, system, viewModel, ko) {
...
define('durandal/widget',['./system', './composition', 'ko'], function (system, composition, ko) {
...
define('durandal/app',['./system', './viewEngine', './composition', './widget', './modalDialog', './events', 'jquery'], 
...
define('main',['durandal/app', 'durandal/viewLocator', 'durandal/system', 'jquery'], function (app, viewLocator, system, $) {
    ...
    app.start().then(function () {
        ...
        var appRoot = $("<div class='__tapyou'></div>").appendTo('body');
